export interface ILocalization {
  ...
  DamageAttribute: { [key: string]: string };
  ...
  StatTooltip: { [key: string]: string };
  SkillType: { [key: string]: string };
  SkillTypeShort: { [key: string]: string };
  IsLimitedFilter: { [key: string]: string };
  IsLimited: { [key: string]: string };
  IsLimitedTooltip: { [key: string]: string };
