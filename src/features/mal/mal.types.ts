...
export declare type TAnimeType =
  | 'tv'
  | 'movie'
  | 'ova'
  | 'special'
  | 'ona'
  | 'music';
export declare type TMangaType =
  | 'manga'
  | 'novel'
  | 'doujin'
  | 'manhwa'
...
export declare type TAnimeStatusUser =
  | 'watching'
  | 'completed'
  | 'on_hold'
  | 'dropped'
  | 'plan_to_watch';
export declare type TMangaStatus =
  | 'publishing'
  | 'complete'
  | 'hiatus'
  | 'discontinued'
  | 'upcoming';
export declare type TMangaStatusUser =
  | 'reading'
  | 'completed'
  | 'on_hold'
  | 'dropped'
  | 'plan_to_read';
export declare type TAnimeRating = 'g' | 'pg' | 'pg13' | 'r' | 'r17' | 'rx';
