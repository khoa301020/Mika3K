...
import { INHentaiModulesGallery, INHentaiModulesResult, T, Tag } from '../../types/nhentai.js';
...
export const NHentaiEmbed = (
  nhentai: INHentaiModulesGallery,
  author: User,
  page?: number,
  total?: number,
): EmbedBuilder => {
...
export const NHentaiListEmbed = (
  nhentai: INHentaiModulesResult,
  author: User,
  page?: number,
  total?: number,
): EmbedBuilder => {
